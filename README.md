...
There's an issue with vis.js on some screen sizes where the graph will flicker back and forth one pixel, in a continuous redraw loop. Only happens on some devices.
